...
result <- setDT(mdl_df)[
  .(mseq = seq(as.Date("1919-01-01"), as.Date("1949-12-30"), by = interval)), 
...
#write.csv(long_scandi, "scandis_in_section_table.csv")
...
```
1618 contracts from 1211 different individuals are found
...
4 people are removed during the analysis since their begin_on_year is later than their end_on_year.
```{r}
