...
employment_distribution(section_da, yseq = seq(0,100,10), group = "Scandinavians in First Division")
...
##New analysis: accumulated experience per year
Experience is interpret as the number of years already in the league. For each year the sum of years, that current workers have already been there is calculated (not counting the current year, this means no value for first year).
This is plottet agaisnt the number of workers per year (this can ofc be changed).
